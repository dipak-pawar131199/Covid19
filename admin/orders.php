    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">MANTHAN Agro Ltd.&nbsp;Melo's</a>
            </div>
						...
						<div class="hero-unit-table">   
                             <table class="table table-striped table-bordered table-hover table-condensed" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $cart_table = mysqli_query($c,"select  * from order_details where status='Pending'") or die(mysqli_error());
                                    ...
                                    while ($cart_row = mysqli_fetch_array($cart_table)) {
                                        ...
                                        $product_query = mysqli_query($c,"select * from tb_products where productID='$product_id'") or die(mysqli_error());
                                        $product_row = mysqli_fetch_array($product_query);
										$member_query = mysqli_query($c,"select * from tb_member where memberID = '$member_id'")or die(mysqli_error());
