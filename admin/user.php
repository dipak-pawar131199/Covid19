			 ...
			 <div class="row">
                    <div class="col-md-12">
						...
						<div class="hero-unit-table">   
                               ...
                               <table cellpadding="1" cellspacing="0" border="1" class="table table-condensed table-striped table-bordered" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($c,"select * from tb_user") or die(mysqli_error());
