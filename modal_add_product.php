                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select type="text" name="category" class = "form-control" placeholder="Category" >
                                            ...
                                            <option></option>
                                            <option>Agricultural Tractor Equipements</option>
                   
                         <option>Agricultural Irrigation System Equipements </option>
                                            <option>Agricultural Hand Equipements</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
...
//
                                ...
                                mysqli_query($c,"insert into tb_products (name,description,category,originated,price,quantity,location)
